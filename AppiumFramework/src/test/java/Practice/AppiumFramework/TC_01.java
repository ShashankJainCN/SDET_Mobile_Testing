...
//Khans Academy
	...
	public void KATestCase2() throws IOException, InterruptedException
	{
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("//*[@text='Shashankjainsj467@gmail.com@gmail.com']")).click();
		Thread.sleep(5000);
	...
	public void KATestCase1() throws IOException, InterruptedException
	{
		...
		Thread.sleep(5000);
		 ...
		 "Shashankjainsj467@gmail.com@gmail.com"); Thread.sleep(9000); driver.hideKeyboard();
		 Thread.sleep(5000);
